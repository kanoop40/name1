...
?>
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="service-39381">
              ...
              <div class="p-4">
                <h3><a href="boat-details.php?bid=<?php echo $result['ID']; ?>"><span class="icon-room mr-1 text-primary"></span>NAME :<?php echo $result['BoatName']?><br> <?php echo $result['Source']?> &mdash; <?php echo $result['Destination']?></a></h3>
                <div class="d-flex">
